 ...
 * window.location.href עם mailto: פותח את תוכנת המייל ב-Outlook/Gmail
 * מבלי לנווט משם.
 */
async function openMailtoWithLink(
  ...
  // 1. מעתיק את קישור הטופס ללוח (גיבוי לאם גוף המייל קצר מדי)
  ...
  // 2. פותח תוכנת מייל – <a>.click() לא גורם לניווט של הדף
  try {
    const body =
      `שלום ${toName},\n\n` +
